...
- All three protected candidates also satisfy a separate stricter screen that forbids buffer-to-buffer overlap. Strict A=`32.2`, B=`30.0`, and C=`26.1` were each solved to matching bounds, so hedging the sample/README contradiction costs no public-instance score.
