...
- The current controller reconstructed all three optimum scores from scratch in 15/15 fixed-policy runs across five seeds: A 20.097–33.840 seconds, B 11.160–23.961, and production C 28.974–39.665. Every schedule hash differed and only local validation applies, so the official ZIPs remain the release artifacts.
