...
- A separately frozen 324-activity, 324-contract shared-bottleneck holdout succeeds 3/3 at the global score floor `0.0` in 2.363/2.774/5.478 seconds. All outputs are dual-scored and strict-clean, and their Live weeks differ from the independent oracle. Profiling shows model construction, not solving, now dominates the direct path; this is the next scale target.
