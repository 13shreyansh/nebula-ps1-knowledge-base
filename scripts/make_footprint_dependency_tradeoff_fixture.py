...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate a footprint-introduced dependency repair fixture."
    )
    ...
    def project(
        ...
        return {
            ...
            "activity_type": "FootprintDependencyTradeoff",
    ...
    projects = [
        ...
        project("KFOLLOW", "Competitor successor", 3, 10, "C"),
    ]
    ...
    activities = [
        ...
        activity("Q004", "FOLLOW", "KFOLLOW", 1, 1, "COMP"),
    ]
    ...
    def emit(
        ...
        result_rows = []
        planned_weeks = {"KDIRECT": 4, "KCOMP": 10, "KFOLLOW": 10}
