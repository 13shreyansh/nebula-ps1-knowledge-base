...
CASES = (
    ...
    ("independent_three_line_A", "fixtures/independent_three_line_v1", "runs/independent_three_line_v1_a", "A", "runs/independent_three_line_v1_a_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_three_line_B", "fixtures/independent_three_line_v1", "runs/independent_three_line_v1_b", "B", "runs/independent_three_line_v1_b_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_three_line_C", "fixtures/independent_three_line_v1", "runs/independent_three_line_v1_c", "C", "runs/independent_three_line_v1_c_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_A", "fixtures/independent_multi_bridge_v1", "runs/independent_multi_bridge_v1_a", "A", "runs/independent_multi_bridge_v1_a_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_B", "fixtures/independent_multi_bridge_v1", "runs/independent_multi_bridge_v1_b", "B", "runs/independent_multi_bridge_v1_b_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_C", "fixtures/independent_multi_bridge_v1", "runs/independent_multi_bridge_v1_c", "C", "runs/independent_multi_bridge_v1_c_audit/stages/scenario_c_verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_congestion_A", "fixtures/independent_multi_bridge_congestion_v1", "runs/independent_multi_bridge_congestion_v1_a", "A", "runs/independent_multi_bridge_congestion_v1_a_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_congestion_B", "fixtures/independent_multi_bridge_congestion_v1", "runs/independent_multi_bridge_congestion_v1_b", "B", "runs/independent_multi_bridge_congestion_v1_b_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_congestion_C", "fixtures/independent_multi_bridge_congestion_v1", "runs/independent_multi_bridge_congestion_v1_c", "C", "runs/independent_multi_bridge_congestion_v1_c_audit/stages/scenario_c_verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_scale_A", "fixtures/independent_multi_bridge_scale_v1", "runs/independent_multi_bridge_scale_v1_a", "A", "runs/independent_multi_bridge_scale_v1_a_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_scale_B", "fixtures/independent_multi_bridge_scale_v1", "runs/independent_multi_bridge_scale_v1_b", "B", "runs/independent_multi_bridge_scale_v1_b_audit/verification_raw/TELEMETRY.json", None, None),
    ("independent_multi_bridge_scale_C", "fixtures/independent_multi_bridge_scale_v1", "runs/independent_multi_bridge_scale_v1_c_compact_t003", "C", None, "ENUMERATED_SINGLE_LANE_LOWER_BOUND", 262.0),
    ...
    ("independent_post_contract_precedence_C", "fixtures/independent_post_contract_precedence_v1", "runs/c_postcontract_precedence_final_repair", "C", "runs/c_postcontract_precedence_final_repair/TELEMETRY.json", None, None),
)
